...
Func _start()
	...
	ConsoleWrite("Click at upper centre of rubber ring 1" & @CRLF)
	...
	ConsoleWrite("Click at upper centre of rubber ring 2" & @CRLF)
	...
	While $bStop <> True
		...
		; check for color at vertical set position and horizontal screen centre + scan-offset

		; if colour is yellow-ish then mouseclick (set | screen centre + small-offset)
